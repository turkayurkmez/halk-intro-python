...
class Calculator:
    def __init__(self):
        self.window = tk.Tk()
        self.window.title("Basit Hesap Makinesi")
    ...
    def create_ui(self):
        ...
        button_frame = tk.Frame(self.window,bg="#11a429")
        ...
        #temizle, geri al
        button_temizle = tk.Button(button_frame,
                                   text="C",
                                   #command=self.clear,
                                   bg="#503e3e",
                                   fg="white",
        ...
        button_temizle.grid(row=0, column=0, columnspan=2, sticky="ew", padx=2, pady=2)
        ...
        for (text,row,column) in buttons:
            if text == "=":
                button = tk.Button(button_frame, command=self.calculate, text=text,bg="red", fg="white",**button_style)
            elif text in "+-*/":
                button = tk.Button(button_frame, command=lambda t= text:self.add_operation(t), text=text,bg="red", fg="white",**button_style)
            else:
                button = tk.Button(button_frame, command=lambda t= text:self.add_number(t), text=text,bg="red", fg="white",**button_style)
